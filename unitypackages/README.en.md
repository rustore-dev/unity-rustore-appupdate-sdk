...
1. Download the package [`RuStoreUnityAppUpdateSDK-x.y.z.unitypackage`][20] and import it into the project (**Assets → Import Package → Custom Package...**).
...
[20]: https://gitflic.ru/project/rustore/unity-rustore-appupdate-sdk/blob/raw?file=unitypackages%2FRuStoreUnityAppUpdateSDK-10.5.1.unitypackage&inline=false
