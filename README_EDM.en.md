...
**External Dependency Manager** for Android is included in the packages <code>ru.rustore.core-<em>version</em>.tgz</code> and <code>RuStoreUnityAppUpdateSDK-<em>version</em>.unitypackage</code>.

When installing RuStore plugins via `*.unitypackage`, **External Dependency Manager** does not require a special installation. You can immediately proceed to the **Setting up External Dependency Manager** section below.
